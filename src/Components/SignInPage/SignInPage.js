    ...
    <div className='sign-in-container'>
      ...
      <div className='signInContainer'>
        ...
        <div className='mobileInputContainer'>
          ...
          {isCreateAccount && ( <input  type='text' className='form-control mobileNumberInput' ref={name} placeholder='Name' size={35}/>)}
         ...
         <p>{loginErrMessage}</p>
          <div className='submitBottomOption'  onClick={handleSignUpForm}> {isCreateAccount ? 'CONTINUE' : 'LOGIN'}</div>
